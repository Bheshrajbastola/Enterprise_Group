...
#define FIREBASE_HOST "attendance-rfid-f69dc-default-rtdb.firebaseio.com" //Without http:// or https:// schemes
#define FIREBASE_AUTH "QVjZXD3Ttak98HSvR6e6rq9dsUYVtzvhMGK6EWaZ"

RFID rfid(4, 5);       //D10:pin of tag reader SDA. D9:pin of tag reader RST 
...
// const int green = D3;
String alertMsg;
String device_id="attendance_Bot";
